...
- [ ] confirm `screen-input-evidence.json` `runId` matches the run directory.
...
- [ ] confirm `outcome-evidence.json` `runId` matches the run directory.
...
do not add `runEvidenceAudited` to proof summaries.
