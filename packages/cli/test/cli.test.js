...
test("proof real-run init creates a non-passing real target-tool run skeleton", () => {
  ...
  try {
    ...
    assert.match(readFileSync(new URL("failure-log.md", runDir), "utf8"), /- flow id: notion-update-task-status/);
    assert.match(readFileSync(new URL("failure-log.md", runDir), "utf8"), /- run id: real-init-validation-001/);
          ...
          steps: [
            {
              ...
              successMatchedVisibleText: ["demo opportunity", "stage"],
            ...
            },
            {
              ...
              successMatchedVisibleText: ["demo opportunity", "qualified", "unsaved changes"],
              successMissingVisibleText: [],
              overlayConfidence: 0.9,
              overlayKind: "instruction",
              overlayCanAutomateInput: false,
            ...
            },
            {
              ...
              successMatchedVisibleText: ["demo opportunity", "qualified", "saved"],
              successMissingVisibleText: [],
              overlayConfidence: 0.9,
              overlayKind: "instruction",
              overlayCanAutomateInput: false,
